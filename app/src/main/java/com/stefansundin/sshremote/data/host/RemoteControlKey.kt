...
val wtypePreset = mapOf(
    ...
    RemoteControlKey.VOLUME_DOWN to Command("wtype -k XF86AudioLowerVolume", repeat = true),
    RemoteControlKey.MUTE to Command("wtype -k XF86AudioMute"),
    RemoteControlKey.VOLUME_UP to Command("wtype -k XF86AudioRaiseVolume", repeat = true),
...
val xdotoolPreset = mapOf(
    ...
    RemoteControlKey.VOLUME_DOWN to Command("DISPLAY=:0 xdotool key XF86AudioLowerVolume", repeat = true),
    RemoteControlKey.MUTE to Command("DISPLAY=:0 xdotool key XF86AudioMute"),
    RemoteControlKey.VOLUME_UP to Command("DISPLAY=:0 xdotool key XF86AudioRaiseVolume", repeat = true),
...
val ydotoolPreset = mapOf(
    ...
    RemoteControlKey.VOLUME_DOWN to Command("ydotool key 114:1 114:0", repeat = true),
    RemoteControlKey.MUTE to Command("ydotool key 113:1 113:0"),
    RemoteControlKey.VOLUME_UP to Command("ydotool key 115:1 115:0", repeat = true),
...
val dotoolPreset = mapOf(
    ...
    RemoteControlKey.VOLUME_DOWN to Command("echo key volumedown | dotool", repeat = true),
    RemoteControlKey.MUTE to Command("echo key mute | dotool"),
    RemoteControlKey.VOLUME_UP to Command("echo key volumeup | dotool", repeat = true),
...
val cecClientPreset = mapOf(
    ...
    RemoteControlKey.VOLUME_DOWN to Command("echo 'vol-down' | cec-client -s", repeat = true),
    RemoteControlKey.MUTE to Command("echo 'mute' | cec-client -s"),
    RemoteControlKey.VOLUME_UP to Command("echo 'vol-up' | cec-client -s", repeat = true),
...
val macosVlcPreset = mapOf(
    ...
    RemoteControlKey.VOLUME_DOWN to Command("osascript -e 'tell application \"VLC\" to volumeDown'", repeat = true),
    RemoteControlKey.MUTE to Command("osascript -e 'tell application \"VLC\" to mute'"),
    RemoteControlKey.VOLUME_UP to Command("osascript -e 'tell application \"VLC\" to volumeUp'", repeat = true),
...
val androidPreset = mapOf(
    ...
    RemoteControlKey.VOLUME_DOWN to Command("input keyevent KEYCODE_VOLUME_DOWN", repeat = true),
    RemoteControlKey.MUTE to Command("input keyevent KEYCODE_VOLUME_MUTE"),
    RemoteControlKey.VOLUME_UP to Command("input keyevent KEYCODE_VOLUME_UP", repeat = true),
